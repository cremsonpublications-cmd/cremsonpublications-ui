...
Most interactive websites use cookies to retrieve user details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
        ...
        <p className="mb-4">
          Unless otherwise stated, Cremson Publications and/or its licensors own the intellectual property rights for all material on Cremson Publications. All intellectual property rights are reserved. You may access this from Cremson Publications for your own personal use subject to restrictions set in these terms and conditions.
        </p>
        <p className="mb-4">You must not:</p>
        <ul className="list-disc list-inside text-black space-y-2 mb-6">
          <li>Republish material from Cremson Publications</li>
          <li>Sell, rent, or sub-license material from Cremson Publications</li>
          <li>Reproduce, duplicate, or copy material from Cremson Publications</li>
          <li>Redistribute content from Cremson Publications</li>
        </ul>
        ...
        <p className="mb-6">
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Cremson Publications does not filter, edit, publish, or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Cremson Publications, its agents, and/or affiliates. Comments reflect the views and opinions of the person who posts their views and opinions. To the extent permitted by applicable laws, Cremson Publications shall not be liable for the Comments or for any liability, damages, or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
        </p>

        <p className="mb-6">
          Cremson Publications reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive, or cause breach of these Terms and Conditions.
        </p>
        ...
        <p className="mb-6">
          You hereby grant Cremson Publications a non-exclusive license to use, reproduce, edit, and authorize others to use, reproduce, and edit any of your Comments in any and all forms, formats, or media.
        </p>
        ...
        <ul className="list-disc list-inside text-black space-y-2 mb-6">
          ...
          <li>Online directory distributors (in the same manner as they hyperlink to the websites of other listed businesses)</li>
        ...
        <ul className="list-disc list-inside text-black space-y-2 mb-6">
          ...
          <li>the benefit to us from the visibility of the hyperlink compensates the absence of Cremson Publications;</li>
        ...
        <p className="mb-6">
          If you are one of the organizations listed above and are interested in linking to our website, you must inform us by sending an e-mail to Cremson Publications. Please include your name, your organization name, contact information, the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
        </p>
        ...
        <p className="mb-6">
          No use of Cremson Publications' logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
